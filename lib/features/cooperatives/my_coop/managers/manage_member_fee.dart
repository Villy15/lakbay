...
class ManageMemberFee extends ConsumerStatefulWidget {
  final BuildContext parentContext;
  final CooperativeModel coop;
  const ManageMemberFee(
      {super.key, required this.parentContext, required this.coop});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _ManageMemberFeeState();
}

class _ManageMemberFeeState extends ConsumerState<ManageMemberFee> {
  ...
  void onSubmit() {
    if (_formKey.currentState!.validate()) {
      ...
      final coop = widget.coop.copyWith(
        membershipFee: double.parse(_feeController.text),
      );
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Manage Member Fee'),
          leading: IconButton(

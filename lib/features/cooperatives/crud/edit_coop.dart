...
class _EditCoopPageState extends ConsumerState<EditCoopPage> {
  // Form key
  ...
  void initState() {
    ...
    // Set initial values
    _nameController.text = widget.coop.name;
    _descriptionController.text = widget.coop.description ?? '';
    _addressController.text = widget.coop.address ?? '';
  ...
  void updateCooperative(CooperativeModel coop) {
                    ...
                    if (_formKey.currentState!.validate()) {
                      ...
                      ref
                          ...
                          .then((value) => value.fold(
                                ...
                                (imageUrl) {
                                  updatedCoop =
                                      updatedCoop.copyWith(imageUrl: imageUrl);
                                  // Register cooperative
                                  updateCooperative(updatedCoop);
                                },
                              ));
                    }
                  },
